          ...
          <div className="py-16 md:py-24 lg:py-32">
            ...
            >
              ...
              <p className="mt-6 max-w-2xl mx-auto text-lg text-muted-foreground text-pretty">
                Kontroller og følg spilletid for hver spiller i santid. Fungerer offline, med smarte forslag til bytter.
              </p>
            </motion.div>
                ...
                {MOCK_MATCHES.map((match, i) => (
                  ...
                  >
                    <Card className="h-full flex flex-col transition-all duration-300 hover:shadow-2xl hover:-translate-y-2">
                      ...
                      <CardFooter>
                        <Button asChild className="w-full bg-heimdal-orange hover:bg-heimdal-orange/90 text-white">
