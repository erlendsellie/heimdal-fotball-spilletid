        ...
        <main>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="py-16 md:py-24 lg:py-32">
              ...
              >
                <img src="https://via.placeholder.com/150x150/006400/ffffff?text=HF" className="mx-auto h-20 w-20 mb-4 rounded-full bg-heimdal-yellow shadow-lg" alt="Heimdal Fotball Logo" />
                  ...
                  {MOCK_MATCHES.map((match, i) => (
                    ...
                    >
                      <Card className="h-full flex flex-col transition-all duration-300 hover:shadow-2xl hover:-translate-y-2">
                        <CardHeader>
                          <CardTitle className="text-xl">Heimdal mot {match.opponent}</CardTitle>
                        ...
                        <CardFooter>
                          <Button asChild className="w-full bg-heimdal-red hover:bg-heimdal-red/90 text-white">
